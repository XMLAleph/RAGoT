...

{
    ...
    "models": {
        "step_by_step_bm25_retriever": {
            "name": "ircot_retrieve_and_reset_paragraphs",
        ...
        "step_by_step_cot_reasoning_gen": {
            "name": "ircot_step_by_step_cot_gen",
        ...
        "answer_main_question": {
            ...
            "prompt_file": "llm_qa_systems/prompts/"+dataset+"/"+rc_context_type+"_context_"+rc_qa_type+"_qa_gpt_3.txt",
            "prompt_reader_args": prompt_reader_args,
            "end_state": "[EOQ]",
            "gen_model": "gpt3",
            "engine": "gpt-3.5-turbo-instruct",
