...
class MultiParaRCReader(DatasetReader):
    def __init__(
        ...
        self.pin_position = pin_position #这里是什么意思?
        self.remove_pinned_para_titles = remove_pinned_para_titles
        self.max_num_words_per_para = max_num_words_per_para #这种参数都按照ircot的配置设置(参考config文件)，先保证能走通整个过程，再逐渐减少可能不需要的参数设置
    ...
    def read_examples(self, file):
        ...
        with open(file, "r") as input_fp:
            ...
            for line in tqdm(input_fp):
                ...
                output_instance["urls"] = [e[0] for e in title_paragraph_tuples]
